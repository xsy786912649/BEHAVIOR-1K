...
def merge_scene_files(scene_a, scene_b, keep_robot_from="b"):
    ...
    for obj_name, obj in scene_a["objects_info"]["init_info"].items():
        if obj["class_name"].lower() in REGISTERED_ROBOTS or obj["class_name"] == "Robot":
            # change class_name to "Robot" for compatibility
            obj["class_name"] = "Robot"
